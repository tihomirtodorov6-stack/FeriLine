...
export default function Home(){
  ...
  // FIXED - без id, Supabase генерира uuid сам
  const handleAuth = async ()=>{
    ...
    if(loginTab==='register'){
      ...
      const appUser = {id:inserted.id, firstName:inserted.first_name, lastName:inserted.last_name, phone:inserted.phone};
